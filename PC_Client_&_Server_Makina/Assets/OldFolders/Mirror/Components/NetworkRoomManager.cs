...
namespace Mirror
{
    ...
    public class NetworkRoomManager : NetworkManager
    {
        ...
        /// </summary>
        /// <param name="p_conn">Connection from client.</param>
        public override void OnServerConnect(NetworkConnection p_conn)
        {
            ...
            base.OnServerConnect(p_conn);
            OnRoomServerConnect(p_conn);
        }
