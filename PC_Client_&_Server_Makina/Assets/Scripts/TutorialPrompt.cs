...
public class TutorialPrompt : MonoBehaviour
{
    ...
    void StartPrompt(KeyCode p_promptEndKey, String p_promptText)
    {
    ...
    {
        //TODO remove this
        if (Input.GetKeyDown(KeyCode.A)) StartPrompt(KeyCode.E, "Press E please sexy");
        
        if (m_promptEndKey != null && Input.GetKeyDown((KeyCode) m_promptEndKey)) StopPrompt();
