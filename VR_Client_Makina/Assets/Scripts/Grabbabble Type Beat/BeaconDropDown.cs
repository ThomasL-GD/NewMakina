...
public class BeaconDropDown : GrabbableDropDownObject {
    ...
    private delegate void DestroyBeaconDelegator(BeaconDropDown p_beaconBehavior);
    ...
    protected override void Start() {
        ...
        BeaconDropDown.OnDestroyBeacon += ActualiseIndex;
    }
    ...
    private void ActualiseIndex(BeaconDropDown p_grabbableObject) {
