...
public class Transition : Synchronizer<Transition> {
    ...
    /// <summary>Is called once a transition is halfway done (thus black screen).<br/>Will NOT be emptied after use so use it carefully ( ◣_◢ )</summary>
    public static Action a_transitionDoneInfinite;
    ...
    private IEnumerator TransitionLoop() {
        ...
        a_transitionDoneInfinite?.Invoke();
        elapsedTime = 0f;
